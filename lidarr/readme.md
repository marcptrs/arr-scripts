...
2. Download the [scripts_init.bash](https://github.com/marcptrs/arr-scripts/blob/main/lidarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/marcptrs/arr-scripts/main/lidarr/scripts_init.bash)) and place it into the following folder:
   `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/marcptrs/arr-scripts/blob/main/lidarr/extended.conf)
...
## Support
[Information](https://github.com/marcptrs/arr-scripts/tree/main?tab=readme-ov-file#support-info)
...
For more details, visit the [Wiki](https://github.com/marcptrs/arr-scripts/wiki/Lidarr)
